  ...
  useEffect(() => {
    const fetchWeather = async () => {
      try {
        ...
        const apiUrl = `https://api.open-meteo.com/v1/forecast?latitude=${latitudes}&longitude=${longitudes}&current=temperature_2m,relative_humidity_2m,weather_code,wind_speed_10m,wind_direction_10m&timezone=auto`;
          ...
          <>
            ...
            <section>
              <List 
                ...
                onViewDetail={setSelectedCityDetail}
              />
            </section>
          </>
        )}
